...
### Install Grobid
> Build from the [latest Grobid repo](https://github.com/kermitt2/grobid) or use [Grobid docker](https://grobid.readthedocs.io/en/latest/Grobid-docker/) if you have problems on installing Grobid.
